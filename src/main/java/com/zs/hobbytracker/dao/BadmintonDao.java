...
public class BadmintonDao {
     ...
     * @throws SQLException
     */
    public void hobbyBadmintonTick(Connection connection, Badminton badminton) throws SQLException {
     ...
     * @throws SQLException
     */
    public List<HobbyAttributes> getBadmintonDataUserWise(Connection connection, int userId) throws SQLException {
